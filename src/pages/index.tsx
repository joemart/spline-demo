...
export default function App() {
    return (
        <Wrapper>
            ...
            {/* <div className='relative text-white font-[16px]'> */}
            <Spline className={`spline`} scene="https://prod.spline.design/zbTwaL0-hYYh3vJx/scene.splinecode" />
            {/* </div> */}
            <Content className={`absolute top-[30px] h-screen flex flex-col justify-center text-white py-0 pl-[100px] pr-[30px] gap-[80px]`}>
                <Menu className={`flex gap-[30px] items-center my-0 mr-[30px] ml-[100px] p-0`}>
                    <li className={``}>
                    ...
                    <li className={``}><Link className={` decoration-none text-white py-2 px-5 border-[1px] border-solid border-[#FFF]/0 transition-[1s] rounded-[14px] duration-1000 hover:border-[#FFF]/20`} href={"#"}>Home</Link></li>
                    <li className={``}><Link className={` decoration-none text-white py-2 px-5 border-[1px] border-solid border-[#FFF]/0 transition-[1s] rounded-[14px] duration-1000 hover:border-[#FFF]/20`} href={"#"}>Download</Link></li>
                    <li className={``}><Link className={` decoration-none text-white py-2 px-5 border-[1px] border-solid border-[#FFF]/0 transition-[1s] rounded-[14px] duration-1000 hover:border-[#FFF]/20`} href={"#"}>App</Link></li>
                    <li className={``}><Link className={` decoration-none text-white py-2 px-5 border-[1px] border-solid border-[#FFF]/0 transition-[1s] rounded-[14px] duration-1000 hover:border-[#FFF]/20`} href={"#"}>Login</Link></li>
                    <li className={``}><button className={`h-fit p-3`}>Get Started</button></li>

                </Menu>

                <h1 className={` font-bold text-[74px] m-0 max-w-[1200px]`}>Collaborate with people</h1>
                <p className={`font-normal leading-[150%] max-w-[300px]`}>Bring your team together and build your community by using our cross-platform app that lets you collaborate via chat, voice and by sharing and storing unlimited media files. A world of topics is waiting for you. Join the private beta.</p>
                <button >
            ...
            {/* <Socials className={`absolute top-[150px] left-[30px] flex flex-col gap-[30px] items-center`}>
                <div className={`w-[1px] h-[500px] bg-[linear-gradient(180deg,_#08b6f9_0%,_#6c56ef_33.57%,_#1306dd_65.86%,_#aa0eb2_100%)]`} />
